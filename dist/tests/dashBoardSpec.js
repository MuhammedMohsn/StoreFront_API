...
var dashboard_model_methods = new dashboard_1.DashboardQueries();
var orders_model = new orders_model_1.OrdersTable();
var users_model = new users_model_1.UsersTable();
describe('test dashboard_model_methods exist or not', function () {
...
describe('test the output of orders_model_methods', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var created_user, created_order, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, orders_model.create(order_test)];
                case 2:
                    created_order = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    err_1 = _a.sent();
                    console.log("we cannot create user or order because ".concat(err_1));
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    }); });
    it('test the output of show_active method ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var active_orders, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, dashboard_model_methods.show_active(order_test.user_id)];
                case 1:
                    active_orders = _a.sent();
                    expect(active_orders).toBeDefined();
                    return [3 /*break*/, 3];
                case 2:
                    err_2 = _a.sent();
                    console.log("we can't show active order because ".concat(err_2));
                    return [3 /*break*/, 3];
